...
# Originally based on: https://github.com/gunnarmorling/1brc/blob/main/src/main/java/dev/morling/onebrc/CreateMeasurements.java
# Adapted copy of: https://github.com/gunnarmorling/1brc/blob/main/src/main/python/create_measurements.py
...
def check_args(file_args):
    ...
    try:
        ...
        print("Usage:  create_measurements.py <positive integer number of records to create> <filename>")
...
def build_test_data(filename, weather_station_names, num_rows_to_create):
    """
...
def main():
    ...
    build_test_data(filename, weather_station_names, num_rows_to_create)
